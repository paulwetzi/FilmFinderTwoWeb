document.addEventListener('DOMContentLoaded', () => {
    ...
    deleteButton.addEventListener('click', async () => {
        ...
        if (storageId) {
            ...
            window.location.href = `http://127.0.0.1:5500/storage.html`;  // Assuming you still want to redirect
        } else {
    ...
    cancelButton.addEventListener('click', () => {
        ...
        if (storageId) {
            window.location.href = `http://127.0.0.1:5500/movie.html?storageId=${storageId}`;
        } else {
