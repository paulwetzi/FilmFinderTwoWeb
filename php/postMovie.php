...
<main class="has-text-centered" id="main-content">
  ...
  <div class="m-3">
    <input type="text" id="titleInput" class="input mb-3" placeholder="Movie Title">
    <input type="text" id="imdb_url" class="input mb-3" placeholder="IMDB URL">
...
<script src="../js/postMovie.js"></script>
</body>
